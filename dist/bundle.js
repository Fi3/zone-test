...
__webpack_require__(26); // eslint-disable-line no-unused-vars


var mountNode = document.getElementById('main');

//$FlowFixMe
_reactDom2.default.render(_react2.default.createElement(_app.App, null), mountNode);
...
// UTILS --section
var getPosterUrl = function getPosterUrl(title) {
  return 'https//:' + title + '.com';
}; // eslint-disable-line

// UPDATE --section


var udpateTitle = function udpateTitle(title) {
  // eslint-disable-line no-unused-vars
  return {
...
var udpateCredentials = function udpateCredentials(credentials) {
  // eslint-disable-line no-unused-vars
  return {
...
var udpateControl = function udpateControl(control) {
  // eslint-disable-line no-unused-vars
  return {
...
var reducer = function reducer(state, action) {
  ...
  switch (action.type) {
    ...
    case 'ActionUpdateCredentials':
      {
        return _extends({}, state, { credentials: action.credentials });
      }
    ...
    case 'ActionUpdateControl':
      {
        return _extends({}, state, { controlState: action.control });
      }
...
var controller = function controller(controlState, action) {
  ...
  if (!controlState.isLoadingMovieList && !controlState.isLoadingGeneres && controlState.hasCredential && controlState.credentialAreValid) {
    return action;
  }
...
// VIEWS --section
var ShowTitle = function ShowTitle(_ref) {
...
var ChangeTitle = function ChangeTitle(_ref2) {
  ...
  return _react2.default.createElement(
    'button',
    {
      onClick: function onClick() {
        return dispatch(controller(control, udpateTitle('cani')));
      }
    },
    'Change Title'
  );
...
var enhance = (0, _recompose.withReducer)('store', 'dispatch', reducer, initialState);
var App = exports.App = enhance(function (_ref3) {
  ...
  return _react2.default.createElement(
    ...
    ChangeTitle({ dispatch: dispatch, control: store.controlState })
  );
});
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(3), __webpack_require__(16)(module)))
